...
roots <- c(
  "mgdriveYLE_sweep_10yr_release_target_fertility"
...
legend_h_cm  <- 0.5 # 0.5    # horizontal bar height (cm)
legend_w_cm  <- max(4, nx * 1.0)  # horizontal bar width (cm)
panel_pad_cm <- 2.0
title_axis_pad <- 4.0
...
png_path <- file.path(out_root, "Fig2.png")
pdf_path <- file.path(out_root, "Fig2.pdf")
