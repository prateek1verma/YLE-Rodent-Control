# Assuming Functional Resistance
generate_YLE_inheritance_cube_funR <- function(c = 0.93, j = 0.25, mu = 0.97, p = 0, q = 0, female_lethality = 1, female_sterility = 1, Haploinsufficient = TRUE, muAd = 1/690, alleleFitness = NULL) {
...
# cube_t1 <- generate_YLE_inheritance_cube_funR(c = 0.93, j = 0.25, mu = 0.97, p = 0, q = 0, female_lethality = 1, female_sterility = 1, Haploinsufficient = TRUE, muAd = 1/690, alleleFitness = NULL)
# cube_t2 <- generate_YLE_inheritance_cube_funR(c = 0.93, j = 0.25, mu = 0.97, p = 0, q = 0, female_lethality = 1, female_sterility = 1, Haploinsufficient = FALSE, muAd = 1/690, alleleFitness = NULL)
