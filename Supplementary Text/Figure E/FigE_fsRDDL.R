...
root            <- "mgdrivefsRIDL_10yrs"   # parent folder with param-tag subfolders
...
## Optional save
out_dir <- root
ggsave(file.path(out_dir, "FigF.png"), p_dual, width = 10, height = 6, dpi = 300)
...
readr::write_csv(
  plot_tbl,
  file.path(out_dir, "fsRRDL_extrema_dual_axis_data_all_scenarios.csv")
)
