...
base_dirs <- (c("mgdriveHomming_ideal_v2","mgdriveHomming_non_ideal_v3", "mgdriveXShredder_ideal_v2", "mgdriveXShredder_non_ideal_v2", "mgdriveYLE_rel_5per_250"))
